...
class Product
{
    ...
    static public function postHandler(array $jsonRequest): array
    {
        self::new(
            ...
            priceMember: (int)$jsonRequest["priceMember"] ?? NULL,
            availableFrom: $jsonRequest["availableFrom"],
            availableUntil: $jsonRequest["availableUntil"],
            maxOrdersPerCustomer: (int)$jsonRequest["maxOrdersPerCustomer"] ?? NULL,
            ...
            inventoryCount: (int)$jsonRequest["inventoryCount"] ?? NULL,
