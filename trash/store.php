<?php if (isset($_REQUEST["error"])) { ?>
	...
	<h1><?php print $t->get_translation("error_header"); ?></h1>
		...
		<a href="mailto:svomming-styret@ntnui.no"><?php print $t->get_translation("contact"); ?></a></p></div>
	...
	<div>
		...
		<div style="width: 100%; float:left;">
			...
			<form id="payment-form" action="<?php print $t->get_url("api/order") ?>" method="POST">
				...
				<?php 
/*	Carefull! data-key was on public internet because it was an html comment. this could happend to live key #pavel
...
?> 
				...
				<button type="submit" style="float: left; width: 45%">Kjøp</button>
				<button onclick="hide_store()" class="locked" style="float: right; width: 45%">Avbryt</button>
			</form>
		</div>
