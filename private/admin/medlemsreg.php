		...
		?>
			...
			<table class="center_table" style="width: 100%">
				...
				<tr>
					...
					<td style="color: <?php if ($triatlon) { print "green"; } else { print "red"; } ?>"><?php print $gammelKlubb ?></td>
				</tr>
				<?php } ?>
<?php if ($kommentar != "") { ?> 		<tr> 
					<td>Kommentar:</td>
...
function godkjenn(id) {
	...
	getJSON("<?php print $base_url ?>/api/memberregister?id=" + id, function (err, json) {
